...
Namespace mstns
	...
	''' <summary>
	''' This class represents the ComplexType ITSPUnit
	''' </summary>
	<LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence, _
													...
													"ITSPUnit", "https://www.itskill.nhs.uk/CDAFile.xsd", true, true, _
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, Nothing, false)> _
	Public Partial Class ITSPUnitB
		Inherits mstns.ITSPCDALib.XmlCommonBase
		Implements mstns.IITSPUnit

		#Region "Constructors"
		''' <summary>
		'''	Constructor for ITSPUnitB
		''' </summary>
		''' <remarks>
		...
		Protected Overrides Sub Init()
			...
			_FontSize = LiquidTechnologies.Runtime.Net45.Conversions.i4FromString("16", LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse)
...
' ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		Public Overrides Function Clone() As Object
			Dim newObject As New mstns.ITSPUnitB(_elementName)
			Dim o As Object
			...
			newObject._IsValidDescription = _IsValidDescription
...
' ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		Public Property UnitName() as String Implements mstns.IITSPUnit.UnitName
			Get 
				Return _UnitName  
			End Get
		...
		Public Property SchemaVersion() as Decimal Implements mstns.IITSPUnit.SchemaVersion
			Get 
		...
		Public Property Type() as String Implements mstns.IITSPUnit.Type
			Get 
				Return _Type  
			End Get
			Set(ByVal value As String) 
		...
		Public Property Height() as Integer Implements mstns.IITSPUnit.Height
			Get 
				Return _Height  
			End Get
		...
		Public Property Width() as Integer Implements mstns.IITSPUnit.Width
			Get 
				Return _Width  
			End Get
			Set(ByVal value As Integer) 
		...
		Public Property PageBackgroundColour() as String Implements mstns.IITSPUnit.PageBackgroundColour
			Get 
		...
		Public Property BrowserBackgroundColour() as String Implements mstns.IITSPUnit.BrowserBackgroundColour
			Get 
		...
		Public Property FontFamily() as String Implements mstns.IITSPUnit.FontFamily
			Get 
				Return _FontFamily  
			End Get
			Set(ByVal value As String) 
		...
		Public Property FontSize() as Integer Implements mstns.IITSPUnit.FontSize
			Get 
				Return _FontSize  
			End Get
			Set(ByVal value As Integer) 
		...
		Public Property InstructionStyle() as String Implements mstns.IITSPUnit.InstructionStyle
			Get 
		...
		Public Property AutoResize() as Boolean Implements mstns.IITSPUnit.AutoResize
			Get 
				Return _AutoResize  
			End Get
		...
		Public Property DisableMobileZoom() as Boolean Implements mstns.IITSPUnit.DisableMobileZoom
			Get 
		...
		Public Property AssessXClicksWrong() as Integer Implements mstns.IITSPUnit.AssessXClicksWrong
			Get 
		...
		Public Property UseKeyboardNavigation() as Boolean Implements mstns.IITSPUnit.UseKeyboardNavigation
			Get 
		...
		Public Property SCOMasteryScore() as LiquidTechnologies.Runtime.Net45.BigInteger Implements mstns.IITSPUnit.SCOMasteryScore
			Get 
		...
		Public Property SCODescription() as String Implements mstns.IITSPUnit.SCODescription
			Get 
		...
		Public Property SCOKeyWords() as String Implements mstns.IITSPUnit.SCOKeyWords
			Get 
				Return _SCOKeyWords  
			End Get
			Set(ByVal value As String) 
		...
		Public Readonly Property PageCol() As mstns.ITSPCDALib.XmlObjectCollection(Of mstns.Page) Implements mstns.IITSPUnit.PageCol
			Get 
				Return _PageCol 
			End Get
		End Property
		...
		Public Readonly Property TutorialList() As mstns.ITSPCDALib.XmlObjectCollection(Of mstns.Tutorials) Implements mstns.IITSPUnit.TutorialList
			Get 
		...
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.AttributeInfoPrimitive("Description", "", "IsValidDescription", LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, Nothing, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		Public Property Description() As String
			Get 
				if (_IsValidDescription = false) Then
					throw new LiquidTechnologies.Runtime.Net45.LtInvalidStateException("The Property Description is not valid. Set DescriptionValid = true")
				End If
				Return _Description  
			End Get
			Set(ByVal value As String) 
		...
		End Property
		''' <summary>
		''' Indicates if Description contains a valid value.
		''' </summary>
		''' <remarks>
		''' true if the value for Description is valid, false if not.
		'''	If this is set to true then the property is considered valid, and assigned its
		'''	default value ("").
		'''	If its set to false then its made invalid, and subsequent calls to get Description
		'''	will raise an exception.
		''' </remarks>
		Public Property IsValidDescription() As Boolean 
			Get
				Return _IsValidDescription
			End Get
			Set(ByVal value As Boolean) 
				If (value <> _IsValidDescription) Then
					Description = ""
					_IsValidDescription = value
				End If
			End Set
		End Property
		Protected _IsValidDescription as Boolean

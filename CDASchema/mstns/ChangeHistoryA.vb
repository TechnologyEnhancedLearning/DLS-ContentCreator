...
Namespace mstns
	...
	''' <summary>
	''' This class represents the ComplexType ChangeHistory
	''' </summary>
	...
	Public Partial Class ChangeHistoryA
		Inherits mstns.ITSPCDALib.XmlCommonBase

		#Region "Constructors"
		''' <summary>
		'''	Constructor for ChangeHistoryA
		''' </summary>
		''' <remarks>
...
' ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		Public Overrides Function Clone() As Object
			Dim newObject As New mstns.ChangeHistoryA(_elementName)
			Dim o As Object

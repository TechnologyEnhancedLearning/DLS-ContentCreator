...
Namespace mstns
	...
	Public Partial Class ShowObjects_Nillable
		...
		''' </remarks>
		Public Sub New()
			_elementName = "ShowObjects_Nillable"
			Init()
		End Sub
...
' ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		Public Overrides Function Clone() As Object
			Dim newObject As New mstns.ShowObjects_Nillable(_elementName)
			Dim o As Object

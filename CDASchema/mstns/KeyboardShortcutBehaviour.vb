...
Namespace mstns
	...
	''' <summary>
	''' This class represents the ComplexType KeyboardShortcutBehaviour
	''' </summary>
	<LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence, _
													...
													"KeyboardShortcutBehaviour", "https://www.itskill.nhs.uk/CDAFile.xsd", true, false, _
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, Nothing, false)> _
	Public Partial Class KeyboardShortcutBehaviour
		Inherits mstns.ITSPCDALib.XmlCommonBase

		#Region "Constructors"
		''' <summary>
		'''	Constructor for KeyboardShortcutBehaviour
		''' </summary>
		''' <remarks>
		...
		''' </remarks>
		Public Sub New()
			_elementName = "KeyboardShortcutBehaviour"
			Init()
		End Sub
		...
		Protected Overrides Sub Init()
			...
			_AltDown = false
			_ShiftDown = false
			_KeyToPress = LiquidTechnologies.Runtime.Net45.Conversions.stringFromString("ANY", LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse)
			_SpecialKey = ""
			_ShowObjects = ""
...
' ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		Public Overrides Function Clone() As Object
			Dim newObject As New mstns.KeyboardShortcutBehaviour(_elementName)
			Dim o As Object
			newObject._CtrlDown = _CtrlDown
			newObject._AltDown = _AltDown
			newObject._ShiftDown = _ShiftDown
			newObject._KeyToPress = _KeyToPress
			newObject._SpecialKey = _SpecialKey
			...
			newObject._AssessCorrect = _AssessCorrect
...
' ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("CtrlDown", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_boolean, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		Public Property CtrlDown() as Boolean
			...
			End Set
		End Property
		Protected _CtrlDown As Boolean

		#End Region
	
		#Region "Attribute - AltDown"
		''' <summary>
		''' Represents a mandatory Element in the XML document
		''' </summary>
		''' <remarks>
		...
		''' It is defaulted to false.
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("AltDown", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_boolean, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		Public Property AltDown() as Boolean
			...
			End Set
		End Property
		Protected _AltDown As Boolean

		#End Region
	
		#Region "Attribute - ShiftDown"
		''' <summary>
		''' Represents a mandatory Element in the XML document
		''' </summary>
		''' <remarks>
		...
		''' It is defaulted to false.
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("ShiftDown", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_boolean, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		...
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("KeyToPress", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		Public Property KeyToPress() as String
			Get 
				Return _KeyToPress  
			End Get
			...
			End Set
		End Property
		Protected _KeyToPress As String

		#End Region
	
		#Region "Attribute - SpecialKey"
		''' <summary>
		''' Represents a mandatory Element in the XML document
		''' </summary>
		''' <remarks>
		...
		''' It is defaulted to "".
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("SpecialKey", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		Public Property SpecialKey() as String
			Get 
				Return _SpecialKey  
			End Get
			Set(ByVal value As String) 
			...
			End Set
		End Property
		Protected _SpecialKey As String

		#End Region
	
		#Region "Attribute - ShowObjects"
		''' <summary>
		''' Objects to show when a key / combination press of the type specified is detected on this object.
		''' </summary>
		''' <remarks>
		''' This property is represented as an Element in the XML.
		''' It is mandatory and therefore must be populated within the XML.
		...
		''' <summary>
		''' Objects to hide when a key / combination press of the type specified is detected on this object.
		''' </summary>
		''' <remarks>
		''' This property is represented as an Element in the XML.
		''' It is mandatory and therefore must be populated within the XML.
		...
		''' <summary>
		''' Objects to animate when a key / combination press of the type specified is detected on this object. These objects need an animate behaviour with AutoStart = False.
		''' </summary>
		''' <remarks>
		''' This property is represented as an Element in the XML.
		''' It is mandatory and therefore must be populated within the XML.
		...
		''' It is defaulted to "".
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("GoToPage", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_string, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Preserve, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		...
		#Region "Attribute - AssessCorrect"
		''' <summary>
		''' Represents a mandatory Element in the XML document
		''' </summary>
		''' <remarks>
		...
		''' It is defaulted to false.
		''' </remarks>
        <LiquidTechnologies.Runtime.Net45.ElementInfoSeqPrimMnd("AssessCorrect", "https://www.itskill.nhs.uk/CDAFile.xsd", Nothing, LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_boolean, Nothing, LiquidTechnologies.Runtime.Net45.WhitespaceUtils.WhitespaceRule.Collapse, "", "-1", "-1", "", "", "", "", "-1", "-1", "-1")> _
		Public Property AssessCorrect() as Boolean
			Get 
				Return _AssessCorrect  
			End Get
			Set(ByVal value As Boolean) 
				CheckElementRestriction(10, value)
				_AssessCorrect = value 
			End Set
		End Property
		Protected _AssessCorrect As Boolean

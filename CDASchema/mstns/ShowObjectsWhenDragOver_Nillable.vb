...
Namespace mstns
	...
	''' <summary>
	''' A list of objects in the page (that are affected by a particular event, for example)
	''' </summary>
	<LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence, _
													...
													"ShowObjectsWhenDragOver_Nillable", "https://www.itskill.nhs.uk/CDAFile.xsd", true, false, _
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, Nothing, false)> _
	Public Partial Class ShowObjectsWhenDragOver_Nillable
		Inherits ITSPCDALib.XmlCommonBase
		Implements LiquidTechnologies.Runtime.Net45.INillable

		#Region "Constructors"
		''' <summary>
		'''	Constructor for ShowObjectsWhenDragOver_Nillable
		''' </summary>
		''' <remarks>
		...
		''' </remarks>
		Public Sub New()
			_elementName = "ShowObjectsWhenDragOver_Nillable"
			Init()
		End Sub
...
' ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		Public Overrides Function Clone() As Object
			Dim newObject As New mstns.ShowObjectsWhenDragOver_Nillable(_elementName)
			Dim o As Object
			newObject._isNil = _isNil
...
' ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		''' </remarks>
		Public Overridable Property IsNil() As Boolean Implements LiquidTechnologies.Runtime.Net45.INillable.IsNil
			Get 
				Return _isNil
			End Get

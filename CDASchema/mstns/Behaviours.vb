...
#Region "ICloneable Interface"
		...
		Public Overrides Function Clone() As Object
			...
			End If
			newObject._ExitLearning = Nothing
			If (Not _Selectable Is Nothing) Then
				newObject._Selectable = CType(_Selectable.Clone(), mstns.SelectableBehaviour)
			End If
			o = Nothing
...
#Region "Attribute - MouseEvent"
		...
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("MouseEvent", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.MouseInteractionBehaviour))>
...
#Region "Attribute - Drag"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("Drag", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.DragBehaviour))>
...
#Region "Attribute - Resize"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("Resize", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.ResizeBehaviour))>
...
#Region "Attribute - Text"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("Text", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.TextBehaviour))>
...
#Region "Attribute - Animate"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("Animate", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.AnimateBehaviour))>
...
#Region "Attribute - MousePointer"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("MousePointer", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.ChangeMousePointerBehaviour))>
...
#Region "Attribute - FollowMouse"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("FollowMouse", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.FollowMouseBehaviour))>
...
#Region "Attribute - ExitLearning"
		...
		''' Only one Element within this class may be set at a time, setting this property when another element is already set will raise an exception. setting this property to null will allow another element to be selected
		''' </remarks>
		<LiquidTechnologies.Runtime.Net45.ElementInfoChoiceClsOpt("ExitLearning", "https://www.itskill.nhs.uk/CDAFile.xsd", LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementType.Element, GetType(mstns.ExitLearningBehaviour))>
		Public Property ExitLearning() As mstns.ExitLearningBehaviour
			Get
				Return _ExitLearning
			End Get
			Set(ByVal value As mstns.ExitLearningBehaviour)
				' The class represents a choice, so prevent more than one element from being selected
				If value Is Nothing Then ClearChoice("") Else ClearChoice("ExitLearning") ' remove selection
				If (value Is Nothing) Then
					_ExitLearning = Nothing
				Else
					SetElementName(value, "ExitLearning")
					_ExitLearning = value
				End If
			End Set
		End Property
		Protected _ExitLearning As mstns.ExitLearningBehaviour

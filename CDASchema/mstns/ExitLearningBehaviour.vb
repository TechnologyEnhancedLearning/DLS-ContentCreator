...
Namespace mstns
	...
	<LiquidTechnologies.Runtime.Net45.XmlObjectInfo(LiquidTechnologies.Runtime.Net45.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"ExitLearningBehaviour", "https://www.itskill.nhs.uk/CDAFile.xsd", True, False,
													LiquidTechnologies.Runtime.Net45.Conversions.ConversionType.type_none, Nothing, False)>
	Partial Public Class ExitLearningBehaviour
		Inherits mstns.ITSPCDALib.XmlCommonBase

#Region "Constructors"
		''' <summary>
		'''	Constructor for ExitLearningBehaviour
		''' </summary>
		''' <remarks>
		...
		''' </remarks>
		Public Sub New()
			_elementName = "ExitLearningBehaviour"
			Init()
		End Sub
...
#Region "ICloneable Interface"
		...
		Public Overrides Function Clone() As Object
			Dim newObject As New mstns.ExitLearningBehaviour(_elementName)
			Dim o As Object
